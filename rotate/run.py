...
def parse_args(args=None):
    ...
    parser.add_argument('--get_model_dataset', action='store_true')
...
def main(args):
    ...
    if args.do_train:
        ...
        train_dataloader_head = DataLoader(
            TrainDataset(train_triples, nentity, nrelation, args.negative_sample_size, 'head-batch', entity2id, relation2id, args.data_path, args.typecons),
        ...
        train_dataloader_tail = DataLoader(
            TrainDataset(train_triples, nentity, nrelation, args.negative_sample_size, 'tail-batch', entity2id, relation2id, args.data_path, args.typecons),
            batch_size=args.batch_size,
            shuffle=True,
            num_workers=max(1, args.cpu_num//2),
            collate_fn=TrainDataset.collate_fn
